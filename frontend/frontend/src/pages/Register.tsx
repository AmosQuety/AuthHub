          ...
          <form action={submitRegister} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input id="email" name="email" type="email" required className="input-field pl-10"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="password" name="password" type="password" required className="input-field pl-10"
                  placeholder="Minimum 8 characters" onChange={e => setPasswordPreview(e.target.value)} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/25 pointer-events-none" />
                <input id="confirm_password" name="confirmPassword" type="password" required className="input-field pl-10"
                  placeholder="••••••••" />
              </div>
            </div>
