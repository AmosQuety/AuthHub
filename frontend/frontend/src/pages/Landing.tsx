    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="#docs" className="text-sm text-[var(--text-muted)] hover:text-[var(--text-base)] transition">Docs</a>
            <button
      ...
      <header className="max-w-6xl mx-auto px-6 py-24">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div id="docs" className="bg-white/5 border border-white/10 rounded-[1.5rem] p-6 backdrop-blur-sm overflow-hidden scroll-mt-28">
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={i} className="flex gap-4 items-start bg-white/5 p-6 rounded-[1.5rem] border border-white/10">
              ...
              <p className="text-[var(--text-base)]">{item}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <footer className="border-t border-white/10 bg-white/5 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 py-12 grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-[var(--text-muted)]">Developer-first identity platform for modern teams.</p>
          </div>
          <div>
            <h4 className="font-bold mb-4 text-sm">Product</h4>
            <ul className="space-y-2 text-sm text-[var(--text-muted)]">
              <li><a href={docsPath} className="hover:text-[var(--text-base)] transition">API Docs</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--text-muted)]">
              <li><a href="https://github.com/AmosQuety/AuthHub" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--text-base)] transition">GitHub</a></li>
              <li><a href="/login" className="hover:text-[var(--text-base)] transition">Roadmap</a></li>
              <li><a href="/login" className="hover:text-[var(--text-base)] transition">Status</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold mb-4 text-sm">Legal</h4>
            <ul className="space-y-2 text-sm text-[var(--text-muted)]">
              <li><a href="/terms" className="hover:text-[var(--text-base)] transition">Terms</a></li>
              <li><a href="/privacy" className="hover:text-[var(--text-base)] transition">Privacy</a></li>
            </ul>
          </div>
        </div>
